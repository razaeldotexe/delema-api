...
Delema API adalah _decision-support engine_ yang dirancang untuk menangani logika kompleks, riset berbasis AI, dan pengambilan data terstruktur. Awalnya ditulis dalam Python/FastAPI, kini telah bermigrasi sepenuhnya ke **Node.js** berperforma tinggi menggunakan **TypeScript**, **Express**, dan **Zod**.
...
- **Wikipedia Intelligence**: Ambil data ensiklopedia dengan dukungan _fallback_ otomatis antara bahasa Inggris dan Indonesia.
- **Hybrid AI Search**: Pencarian produk dan konten pintar yang menggabungkan data real-time dan pemrosesan LLM.

### 🏥 Healthcare Data

- **OpenFDA Integration**: Akses cepat ke database FDA untuk informasi obat (_drug_), makanan (_food_), dan perangkat medis (_device_).
...
Semua _endpoint_ menggunakan prefix: `{domain}/api/delema/v1/`
